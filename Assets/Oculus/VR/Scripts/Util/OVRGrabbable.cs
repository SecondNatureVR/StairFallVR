...
public interface IGrabbableMessageTarget : IEventSystemHandler
{
    void OnGrabBegin();
    void OnGrabEnd();
}
...
public class OVRGrabbable : MonoBehaviour
{
	...
	virtual public void GrabBegin(OVRGrabber hand, Collider grabPoint)
    {
        ...
        ExecuteEvents.Execute<IGrabbableMessageTarget>(transform.root.gameObject, null, (x, y) => x.OnGrabBegin());
    }
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity)
    {
        ...
        ExecuteEvents.Execute<IGrabbableMessageTarget>(transform.root.gameObject, null, (x, y) => x.OnGrabEnd());
    }
